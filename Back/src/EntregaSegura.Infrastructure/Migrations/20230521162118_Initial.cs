    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Bairro Teste", "12345678", "12345678912345", "Cidade Teste", null, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(4992), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(4984), null, "condominio1@teste.com", "SP", "Rua Teste", "Condominio Teste 1", "123", 3, 3, 90, "1234567890" },
                    { 2, "Bairro Teste 2", "12345679", "12345678912346", "Cidade Teste", null, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5003), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5002), null, "condominio2@teste.com", "SP", "Avenida Teste", "Condominio Teste 2", "456", 2, 2, 60, "1234567891" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "12345678912347", new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5205), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5205), null, "transportadora1@teste.com", "Transportadora Teste 1", "1234567894" },
                    { 2, "12345678912348", new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5207), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5207), null, "transportadora2@teste.com", "Transportadora Teste 2", "1234567895" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "12345678903", 3, 1, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5186), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5185), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5184), null, null, "funcionario1@teste.com", "Funcionario Teste 1", "1234567892" },
                    { 2, "12345678904", 2, 2, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5189), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5188), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5188), null, null, "funcionario2@teste.com", "Funcionario Teste 2", "1234567893" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A", 1, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5106), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5106), null, "101" },
                    { 2, "A", 1, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5109), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5109), null, "102" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "12345678901", new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5166), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5166), null, "morador1@teste.com", "foto1.jpg", "Morador Teste 1", "123", "1234567890", 1 });

            migrationBuilder.InsertData(
                table: "TB_MORADORES",
                columns: new[] { "MOR_ID", "MOR_CPF", "MOR_DATA_ATUALIZACAO", "MOR_DATA_CRIACAO", "MOR_DATA_EXCLUSAO", "MOR_EMAIL", "MOR_FOTO", "MOR_NOME", "MOR_RAMAL", "MOR_TELEFONE", "MOR_UNIDADE_ID" },
                values: new object[] { 2, "12345678902", new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5170), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5169), null, "morador2@teste.com", "foto2.jpg", "Morador Teste 2", "456", "1234567891", 2 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5219), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5219), null, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5219), null, "Entrega Teste 1", 1, 1, "Observação Teste 1", 1, 1 });

            migrationBuilder.InsertData(
                table: "TB_ENTREGAS",
                columns: new[] { "ETG_ID", "ETG_DATA_ATUALIZACAO", "ETG_DATA_CRIACAO", "ETG_DATA_EXCLUSAO", "ETG_DATA_RECEBIMENTO", "ETG_DATA_RETIRADA", "ETG_DESCRICAO", "FUN_ID", "MOR_ID", "ETG_OBSERVACAO", "ETG_STATUS", "TRP_ID" },
                values: new object[] { 2, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5221), new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5221), null, new DateTime(2023, 5, 21, 13, 21, 17, 880, DateTimeKind.Local).AddTicks(5222), null, "Entrega Teste 2", 2, 2, "Observação Teste 2", 1, 2 });
