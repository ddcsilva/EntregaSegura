...
public class MoradorTests
{
    ...
    {
        var morador = new Morador(null, "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", "", "", 1);
    ...
    public void Deve_Gerar_Erro_Quando_Nome_For_Muito_Longo()
    {
        ...
        var morador = new Morador(nomeMuitoLongo, "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", "", "", 1);
        var resultadoValidacao = _validator.Validate(morador);
        resultadoValidacao.Errors.Should().Contain(failure => failure.PropertyName == nameof(morador.Nome));
    }
    ...
    {
        var morador = new Morador("a", "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", "", "", 1);
        var resultadoValidacao = _validator.Validate(morador);
        resultadoValidacao.Errors.Should().Contain(failure => failure.PropertyName == nameof(morador.Nome));
    }
    ...
    {
        var morador = new Morador("Morador", "123", "morador@morador.com.br", "(11) 2345-6789", "", "", 1);
        var resultadoValidacao = _validator.Validate(morador);
    ...
    {
        var morador = new Morador("Morador", "111.111.111-11", "morador@morador.com.br", "123", "", "", 1);
        var resultadoValidacao = _validator.Validate(morador);
    ...
    {
        var morador = new Morador("Morador", "111.111.111-11", "invalid", "(11) 2345-6789", "", "", 1);
        var resultadoValidacao = _validator.Validate(morador);
    ...
    {
        var morador = new Morador("Morador", "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", "", "", 1);
        var resultadoValidacao = _validator.Validate(morador);
