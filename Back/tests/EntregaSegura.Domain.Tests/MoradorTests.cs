...
//     {
//         var morador = new Morador(null, "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", 0, 1);
...
//         var morador = new Morador(nomeMuitoLongo, "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", 0, 1);
//         var resultadoValidacao = _validator.Validate(morador);
//         resultadoValidacao.Errors.Should().Contain(failure => failure.PropertyName == nameof(morador.Nome));
//     }
...
//     {
//         var morador = new Morador("a", "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", 0, 1);
//         var resultadoValidacao = _validator.Validate(morador);
//         resultadoValidacao.Errors.Should().Contain(failure => failure.PropertyName == nameof(morador.Nome));
//     }
...
//     {
//         var morador = new Morador("Morador", "123", "morador@morador.com.br", "(11) 2345-6789", 0, 1);
//         var resultadoValidacao = _validator.Validate(morador);
...
//     {
//         var morador = new Morador("Morador", "111.111.111-11", "morador@morador.com.br", "123", 0, 1);
//         var resultadoValidacao = _validator.Validate(morador);
...
//     {
//         var morador = new Morador("Morador", "111.111.111-11", "invalid", "(11) 2345-6789", 0, 1);
//         var resultadoValidacao = _validator.Validate(morador);
...
//     {
//         var morador = new Morador("Morador", "111.111.111-11", "morador@morador.com.br", "(11) 2345-6789", 0, 1);
//         var resultadoValidacao = _validator.Validate(morador);
