...
export class EntregasComponent implements OnInit, OnDestroy {
  ...
  public dataSource: MatTableDataSource<Entrega> =
      ...
      dialogRef.afterClosed().subscribe((result) => {
        if (result) {
          this.entregaService.confirmarRetirada(id).subscribe({
            next: () => {
              this.toastr.success(
                'Retirada da entrega pelo morador confirmada com sucesso!',
                'Sucesso!'
              );
              this.obterEntregas();
            },
      ...
      dialogRef.afterClosed().subscribe((result) => {
        if (result) {
          this.entregaService.notificarEntrega(id).subscribe({
            next: () => {
              this.toastr.success(
                'Notificação enviada para o morador com sucesso!',
                'Sucesso!'
              );
              this.obterEntregas();
            },
  ...
  private obterEntregas(): void {
    this.entregaService
      .obterEntregas(this.emailUsuario, this.perfilUsuario)
